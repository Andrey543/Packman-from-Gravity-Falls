...
def menu():
    ...
    back=Rect(14*cell_size,14*cell_size,feild_size_x,feild_size_y)
    menu_image=pygame.image.load('./resources/menu.png')
    play_image=pygame.image.load('./resources/play.png')
    play_image_pressed=pygame.image.load('./resources/play_pressed.png')
    choose_the_map_image=pygame.image.load('./resources/choose_the_map.png')
    choose_the_map_image_pressed=pygame.image.load('./resources/choose_the_map_pressed.png')
    quit_image=pygame.image.load('./resources/quit.png')
    quit_image_pressed=pygame.image.load('./resources/quit_pressed.png')
    map1_image=pygame.image.load('./resources/map_1.png')
    map1_image_pressed=pygame.image.load('./resources/map_1_pressed.png')
    map2_image=pygame.image.load('./resources/map_2.png')
    map2_image_pressed=pygame.image.load('./resources/map_2_pressed.png')
    back_image=pygame.image.load('./resources/back.png')
    back_image_pressed=pygame.image.load('./resources/back_pressed.png')
    background=pygame.image.load('./resources/background_for_menu.png')
